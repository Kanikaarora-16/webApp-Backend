...
@Component
public class WebApplicationUtilImpl implements WebApplicationUtil {
	private static final Logger LOGGER = LoggerFactory.getLogger(WebApplicationUtilImpl.class);
	 ...
	 * 
	 * @see
	 * com.project.form.util.NumberToWordConverterUtil#convertToWords(java.lang.
	 * Long)
	 */
	public String convertToWords(Long number) {
		LOGGER.info("Inside convertToWords method");
		String inWords = "";
